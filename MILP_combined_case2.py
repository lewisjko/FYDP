...
#            LP += RNG_max <= CO2_available
        ...
        LP += H2_3[h] >= 0.5 * mobility_demand[i]
        LP += H2_3[h] <= 1.5 * mobility_demand[i]

        # Industry demand constraint
        LP += H2_4[h] >= 0.5 * industry_demand[i]
        LP += H2_4[h] <= 1.5 * industry_demand[i]
        ...
        LP += 0.95 * RNG[h] >= 0.05 * (NG[h] + H2_2[h])

        # HENG demand constraints
        LP += 0.925 * H2_2[h] <= 0.075 * (NG[h] + RNG[h])
        LP += 0.975 * H2_2[h] <= 0.025 * (NG[h] + RNG[h])
